...
func AdminSignup(c *gin.Context) {
	...
	// validations
	if inputAdmin.AdminName == "" || inputAdmin.Email == "" || inputAdmin.Password == "" || inputAdmin.Phone == "" || inputAdmin.Age == 0 || inputAdmin.Location == "" {
		c.JSON(400, gin.H{
...
func AdminChangePass(c*gin.Context){
	...
	type AdminChangePass struct {
		Email string       `json:"email" form:"email"`
		Olpassword string  `json:"oldpassword" form:"email"`
